 ...
 220  GOSUB 5100: GOSUB 5000: A = PEEK(7)
 ...
 362  IF WT%<9 THEN N = 15: GOSUB 5002
 363  IF WT%>8 THEN N = 14: GOSUB 5002
 ...
 510  IF  PEEK (7) = 7 AND WY% = 0 THEN HOME: VTAB 21: PRINT "BLOCKED BY MARINE. ";: GOSUB 30050: HOME : GOTO 100
 520  N = 4: GOSUB 5001: N = 15: GOSUB 5002: FL% = 16: GOTO 100

 600  GOSUB 5000
 610  IF  FL% <> 16 OR PEEK(6) <> 4 THEN 8070
 620  FL% = 0: N = 11: GOSUB 5001: GOTO 100
 ...
 790  N = 10: GOTO 810
 800  N = 5
 810  GOSUB 850: IF PEEK(6)=N THEN 815
 812  HOME: VTAB 21: PRINT "WRONG TARGET.";: GOSUB 30050: HOME: GOTO 100
 815  GOSUB 2300
 816  HOME: VTAB 21: PRINT "-CASTING ";B$;"-": GOSUB 30000
 830  N = 13: XT=XT+XK: YT=YT+YK: GOSUB 5001: GOSUB 880: HOME: GOTO 100

 850  HOME : VTAB 21: PRINT "WHICH DIRECTION: ";: GET A$: PRINT: GOSUB 5100: GOSUB 5000
 ...
 1100  HOME: VTAB 21: GOSUB 5000: M = PEEK(6): IF M <>0 AND M <> 9 AND M <> 14 THEN PRINT "NOTHING TO STEAL. ";: GOSUB 30050: HOME: GOTO 100
 ...
 1300  C = 100: I = 99 * RND(1): IF I>89 THEN C = 50
 ...
 5002  POKE 8190,XT: POKE 8191,YT: POKE 6,255: POKE 7,N: CALL 7504: RETURN
 ...
 7400  HOME: VTAB 21: GOSUB 5000: M = PEEK(6) + 1: A = PEEK(7)
 ...
 7599  POKE 216,0: HOME: VTAB 21: PRINT "NOBODY HERE! ";: GOSUB 30050: HOME : GOTO 100

 7600  CALL 7850: PRINT " ";: A = PEEK(30)
 7610  ONERR GOTO 9250
 7620  IF A = 1 THEN 7714
 7621  IF A = 5 THEN 7716
 7622  IF A = 6 THEN 7718
 7623  IF A = 12 AND FG%(5)<32 THEN 7719
 7660  POKE 216,0
 7661  IF A = 2 THEN 7720
 7664  IF A = 9 THEN 7730
 7666  IF A = 14 THEN 7740
 7667  IF A = 15 THEN 7750
 7668  IF A = 16 THEN 7760
 7669  IF A = 18 THEN 7770
 7699  GET A$: HOME : GOTO 100

 7700  PRINT : PRINT CHR$(4);"BLOAD PROG/FOOD": GOTO 8910
 7702  PRINT : PRINT CHR$(4);"BLOAD PROG/PUB": GOTO 8900
 ...
 7754  HOME : VTAB 21: PRINT "WRONG! ";: GOSUB 30050: HOME : GOTO 100
 7755 XT = XT + 6: HOME : GOTO 100

 7760  PRINT : GOSUB 7000: IF  LEFT$ (B$,5) <> "SOULS" THEN 7721
 7761  HOME : VTAB 21: PRINT "-SUMMONING PHANTOM SHIP-": GOSUB 30000: POKE 28270,75: POKE 29100,254: HOME : GOTO 100
 ...
 25000  ONERR GOTO 9250
 25001  PRINT: PRINT CHR$(4);"BLOAD ";RB$;"TWNSPS,A$800": POKE 216,0: GOTO 100
