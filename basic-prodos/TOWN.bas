...
7711  PRINT : PRINT CHR$(4);"BLOAD PROG/SAGE": GOTO 8910
7712  PRINT : PRINT CHR$(4);"BLOAD PROG/ARCHWIZ": GOTO 8910
7713  PRINT : PRINT CHR$(4);"BLOAD PROG/ALCHEMIST": GOTO 8900
7714  IF FG%(5)=32 THEN POKE 216,0: PRINT "VANQUISHER! ";: GOTO 7699
7715  PRINT : PRINT CHR$(4);"BLOAD PROG/BARON": GOTO 8900
...
7761  HOME : VTAB 21: PRINT "-SUMMONING PHANTOM SHIP-": GOSUB 30000: YT = YT + 1: N=11: GOSUB 5001: YT = YT - 1: N=14: GOSUB 5002: HOME : GOTO 100
...
7999 HOME : VTAB 21: PRINT "YOU DON'T HAVE THE GOLD! ";: GOSUB 30050: HOME : GOTO 100
