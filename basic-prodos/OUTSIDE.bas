...
10000  R% = 0: HOME: VTAB 21: PRINT "SAVE GAME ? (Y/N) ";: GET A$: IF A$<>"Y" AND A$<>"N" THEN 10000
...
10013  GOSUB 9000: POKE 2048,0: POKE 103,1: POKE 104,8: PRINT CHR$(4);"RUN PROG/LAUNCH"
10020  GOSUB 9000: PRINT CHR$(4);"BLOAD PROG/SAVE.GAME"
10030  POKE 2048,0: POKE 103,1: POKE 104,8: GOTO 0

10100  R% = 1: HOME: VTAB 21: PRINT "REORDER PARTY - PROCEED (Y/N): ";: GET A$: IF A$ <> "Y" AND A$ <> "N" THEN 10100
10110  IF A$ = "Y" THEN 10020
10120  HOME: GOTO 100
