...
5  PRINT CHR$(4);"BLOAD ";RB$;"OUTSPS,A$800"
6  GOSUB 300
...
139  X = X + XK: Y = Y + YK: RETURN

140  POKE 8190,X: POKE 8191,Y: CALL 7486: RETURN
141  POKE 8190,X: POKE 8191,Y: POKE 6,N: POKE 7,255: CALL 7504: RETURN
...
250  GOSUB 140: IF PEEK(6)=11 THEN N = 4: GOSUB 141
...
510  MD% = 1: FL%=16: N = 4: GOSUB 141: GOTO 100

600  GOSUB 140: IF FL% = 32 THEN 400
610  IF  FL% <> 16 OR PEEK(6) <> 4 THEN 8070
620  MD% = 1: FL% = 0: N = 11: GOSUB 141: GOTO 100
...
8410  GOSUB 8600
8420  IF N = 0 THEN PRINT "YOU DON'T HAVE THE RIGHT KEY.";: GOTO 199
...
8520  IF N = 0 THEN PRINT "YOU DON'T HAVE THE RIGHT PRISM.";: GOTO 199
...
10013  GOSUB 9000: TEXT: HOME: PRINT "LOADING...": POKE 2048,0: POKE 103,1: POKE 104,8: PRINT CHR$(4);"RUN PROG/LAUNCH"
10020  GOSUB 9000: PRINT CHR$(4);"BLOAD PROG/SAVE.GAME"
