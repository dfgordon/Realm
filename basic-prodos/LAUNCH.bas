...
100  HOME: PRINT "REALM V1.4.0. SELECT ONE-": VTAB 24: PRINT "PLEASE USE CAPS LOCK";
...
280  RETURN
290  PRINT CL$(A);" CANNOT BE A ";RA$(A): GET A$: GOTO 250
...
364  M = 0: N = 0: P = 5: GOSUB 380
365  AF%(A) = A%(0): AG%(A) = A%(1): AH%(A) = A%(2): AI%(A) = A%(3): AJ%(A) = A%(4): AK%(A) = A%(5): IF C = 0 THEN RETURN
366  HTAB 1: VTAB 14: PRINT "UNUSED POINTS! ";: GET A$: GOTO 361
...
380  VTAB 12: PRINT "ARROWS/A/Z, ENTER- ": PRINT "(REDUCE, THEN INCREASE)"
381  HTAB 1: VTAB N+3: I=N: GOSUB 350: PRINT ": ";A%(I);TAB(38): INVERSE: HTAB 1: VTAB M+3: I=M: GOSUB 350: NORMAL: PRINT ": ";A%(I);TAB(38)
382  HTAB 9: VTAB 10: PRINT C;TAB(38): HTAB 20: VTAB 12: GET A$: GOSUB 370: IF A$ = CHR$(13) THEN RETURN
