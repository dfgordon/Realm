...
40  HOME: PRINT "REALM V1.5.1": VTAB 24: PRINT "PLEASE USE CAPS LOCK";
...
120  PRINT: PRINT CHR$(4);"PREFIX ";P0$: RETURN: REM PREFIX
...
160  PRINT " (Y/N) ? ";: REM BINARY CHOICE
...
710  PRINT: PRINT "SCANNING...": COUNT = 0: &("VOLS",VO$,CAP,COUNT): IF COUNT=0 THEN HOME: PRINT "NO VOLUMES FOUND ";: GET A$: PS$ = "": RETURN
...
730  IF A$ = CHR$(9) THEN POKE 34,1: HOME: POKE 34,0: GOTO 710
...
6301  ONERR GOTO 9900
6302  PRINT CHR$(4);"PREFIX ";PD$
6310  ONERR GOTO 9930
6311  PRINT CHR$(4);"VERIFY D.";NA$
6320  HOME: PRINT NA$;" ALREADY HERE.": PRINT "OVERWRITE";: GOSUB 160: IF A$ = "N" THEN 6371
6330  HOME: PRINT "PARTY: ";NA$: PRINT "SOURCE PREFIX:": PRINT " ";PS$: PRINT "DESTINATION PREFIX:": PRINT " ";PD$
6331  PRINT: PRINT "IF TWO DISKS BOTH MUST BE INSERTED."
6340  PRINT "BEGIN";: GOSUB 160: IF A$ = "N" THEN 6371
6350  PRINT: PRINT "WORKING...": ONERR GOTO 9900
6360  FS$ = "D." + NA$: GOSUB 80
6361  FS$ = "AR." + NA$: GOSUB 80
6362  FS$ = "AB." + NA$: GOSUB 80
6363  FS$ = "FO." + NA$: GOSUB 80
6364  FS$ = "WO." + NA$: GOSUB 80
6370  PRINT: PRINT "FINISHED. PRESS ANY KEY.";: GET A$
6371  GOSUB 120: POKE 216,0: RETURN

6400  REM IMPORT
6401  ONERR GOTO 9900
...
6500  REM EXPORT
6501  ONERR GOTO 9900
6510  GOSUB 900: HOME: PRINT "--EXPORT PARTY--": PRINT: GOSUB 400 : IF M = 0 THEN POKE 216,0: GOTO 40
6530  WS = 2: WP = 2: POKE 34,1: HOME: POKE 34,0: GOSUB 700: IF PS$ = "" THEN POKE 216,0: GOTO 40
...
9140  ONERR GOTO 9900
9141  GOSUB 120: POKE 216,0: RETURN

9900  HOME: PRINT CHR$(7);"THERE WAS PROBABLY A DISK ERROR.": PRINT "ERROR ";PEEK(222);" ON LINE ";PEEK(218)+PEEK(219)*256;". "
9910  PRINT "WE MUST RETURN TO THE MAIN MENU."
9920  PRINT "RESTORE REALM DISK IF REMOVED- ";: GET A$: CALL -10621: GOSUB 120: POKE 216,0: GOTO 40
9930  IF PEEK(222) = 6 OR PEEK(222) = 7 THEN CALL -3288: GOTO 6330
9940  GOTO 9900
9950  CALL -3288: PRINT "RAM DISK ERROR. PROCEEDING WITHOUT. ";: GET A$: RB$ = "BIN" + "/": RD$ = "PROG" + "/": GOTO 9140
