 ...
 5040  IF A$ = "Y" THEN RB$ = "/RAM" + "/": RD$ = "/RAM" + "/"
 5045  GOTO 5100
 ...
 6055  POKE 8183,0: POKE 8184,8: POKE 8188,0: POKE 8189,110: REM ASSUME CONSTANT
 ...
 9030  PRINT CHR$(4);"BLOAD TWNSPS,A$4000": GOSUB 9100: PRINT CHR$(4);"BSAVE /RAM/TWNSPS,A";A;",L";L
 9031  PRINT CHR$(4);"BLOAD DNGNSPS,A$4000": GOSUB 9100: PRINT CHR$(4);"BSAVE /RAM/DNGNSPS,A";A;",L";L
 9032  PRINT CHR$(4);"BLOAD OUTSPS,A$4000": GOSUB 9100: PRINT CHR$(4);"BSAVE /RAM/OUTSPS,A";A;",L";L
