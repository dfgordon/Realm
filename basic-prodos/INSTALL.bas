...
5  A1ERR = 6: A2DBG = 8: POKE 1013,76: POKE 1014,0: POKE 1015,64
...
1050  PAGE = 0
1060  GOSUB 170
1070  HOME: PRINT: PRINT "CURRENT PATH:": PRINT PTH$: B$ = " ": L = 7
...
6000  PRINT: PRINT "UNRECOVERABLE ERROR ";PEEK(222);" ON LINE ";PEEK(218)+PEEK(219)*256: GOTO 9999
6010  PRINT "ERROR ";PEEK(222): PRINT "IF UPGRADING EXPORT PARTIES AND THEN"
6011  PRINT "DELETE OLD INSTALLATION": GOTO 9999
