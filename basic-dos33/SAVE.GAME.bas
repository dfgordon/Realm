...
2  GOSUB 700: IF R% = 1 THEN HOME: VTAB 21: PRINT "REORDER REQUIRES EXIT TO MENU- ";: GET A$: GOTO 12

10  HOME: VTAB 21: PRINT NA$;": PROGRESS IS SAVED."
11  PRINT "EXIT TO MENU";: GOSUB 160: IF A$ = "N" THEN PRINT: GOTO 20
12  D = 3: GOSUB 9000: TEXT: HOME: PRINT "LOADING...": PRINT CHR$(4);"RUN LAUNCH"
...
130  HTAB 1: VTAB 21: PRINT "ORDER OK";: GOSUB 160: IF A$ = "N" THEN 100
140  RETURN
