...
100  HOME: PRINT "REALM V1.5.1": VTAB 24: PRINT "PLEASE USE CAPS LOCK";
...
3010  PRINT: PRINT "RENAMING ";NA$: PRINT "PLEASE DO NOT RENAME A DEPLOYED PARTY.": PRINT "CONTINUE";: GOSUB 160: IF A$ = "N" THEN 100
...
4010  PRINT: PRINT "DELETING ";NA$: PRINT "PLEASE DO NOT DELETE A DEPLOYED PARTY.": PRINT "CONTINUE";: GOSUB 160: IF A$ = "N" THEN 100
...
6100  HOME: PRINT NA$;" ALREADY DEPLOYED.": PRINT "RECALL";: GOSUB 160: IF A$ = "N" THEN 100
6120  GOSUB 500
...
6500  REM EXPORT
6501  D = 3: GOSUB 9000: GOSUB 900: HOME: PRINT "--EXPORT PARTY--": HTAB 1: VTAB 3: GOSUB 400: IF M = 0 THEN 100
6510  ONERR GOTO 6600
6520  PRINT: PRINT "READING...": GOSUB 500
6530  HOME: PRINT "--EXPORT PARTY--": GOSUB 6550
6540  PRINT "EXPORTING ";NA$: PRINT "PLEASE DO NOT EXPORT A DEPLOYED PARTY.": PRINT "CONTINUE";: GOSUB 160: IF A$ = "Y" THEN PRINT: PRINT "WRITING...": GOSUB 700
...
6553  PRINT D
6554  HTAB 1: VTAB 5: INPUT "AUXILIARY DISK VOLUME (1-255,ENT): ";A$: V = INT(VAL(A$)): IF A$ = "" THEN V = 254
6555  IF V<1 OR V>255 THEN 6554
6556  PRINT "INSERT DISK (ESC CANCELS)- ";:GET A$: IF A$ = CHR$(27) THEN POKE 216,0: CALL -10621: GOTO 100
6557  PRINT: PRINT CHR$(4);"CATALOG,S";S;",D";D;",V";V
6560  PRINT: RETURN
