 ...
 40  GOSUB 5300
 100  TEXT : HOME
 110  PRINT "REALM V1.4.0. SELECT ONE-": PRINT
 ...
 1260  IF CL$(L) = "CLERIC" THEN AB%(L) = 60: WT%(L) = 20
 1270  IF CL$(L) = "FIGHTER" THEN AB%(L) = 100: WT%(L) = 20
 1280  IF CL$(L) = "MONK" THEN AB%(L) = 80: WT%(L) = 10
 1290  IF CL$(L) = "PALADIN" THEN AB%(L) = 80: WT%(L) = 10
 1300  IF CL$(L) = "RANGER" THEN AB%(L) = 80: WT%(L) = 10
 1310  IF CL$(L) = "THIEF" THEN AB%(L) = 60: WT%(L) = 20
 1320  IF CL$(L) = "WIZARD" THEN AB%(L) = 50: WT%(L) = 25
 1330 AB%(L) = AB%(L) + AJ%(L)
 1340 AB%(L) = AB%(L) * 2
 1350 AC%(L) = AB%(L)
 1390  NEXT L
