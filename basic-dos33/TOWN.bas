...
7711  PRINT : PRINT CHR$(4);"BLOAD SAGE": GOTO 8910
7712  PRINT : PRINT CHR$(4);"BLOAD ARCHWIZ": GOTO 8910
7713  PRINT : PRINT CHR$(4);"BLOAD ALCHEMIST": GOTO 8900
7714  IF FG%(5)=32 THEN POKE 216,0: PRINT "VANQUISHER! ";: GOTO 7699
7715  PRINT : PRINT CHR$(4);"BLOAD BARON": GOTO 8900
