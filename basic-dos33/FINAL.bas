...
9120  HTAB 1: PRINT  CHR$(4);"VERIFY DISK";D;",S";WS%(D);",D";WD%(D);",V";WV%(D): POKE 216,0: RETURN
9200  HTAB 1: VTAB 15: PRINT "INSERT ";DL$(D);" DISK IN D";WD%(D);"- ";: GET A$: CALL 768: PRINT : RESUME
