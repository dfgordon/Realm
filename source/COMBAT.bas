 ...
 207  IF AA% = 1 AND GP%(L) > 0 THEN 600
 ...
 240  IF A$ = "W" THEN 500
 250  IF A$ = "A" THEN AA% = 0: GOTO 600
 255  IF A$ = CHR$(1) THEN AA% = 1: GOTO 600
 ...
 318  IF W$ = "HAS" THEN WA = 6: WB = 35: IF CL$(L) = "MONK" THEN WA = 10 + ZA%: WB = ZA%*10 + 50: MA = 2 + ZA%/3
 319  IF W$ = "SWT" THEN WA = 75:WB = 85
 ...
 326  IF W$ = "STG" THEN WA =  - 50:WB = 70:SC$ = "I"
 327  IF W$ = "STR" THEN WA =  - 65:WB = 80:WR = 1:SC$ = "I"
 328  IF W$ = "STH" THEN WB = 60:SC$ = "P":SD$ = "KIL"+"LED":MA = 3
 329  IF W$ = "LID" THEN WA =  - 50:WB = 70:WR = 1:SC$ = "I":SE$ = "L"
 ...
 650  IF SC$ = "I" THEN 2040
 660  IF SC$ = "P" THEN 2020
 670  GOTO 1000

 700  HOME : VTAB 21: PRINT "INVALID WEAPON! ";: GOSUB 30050: AA% = 0: GOTO 204
 ...
 900  HOME
 910  VTAB 21: PRINT "ATTACK WHICH ";GO$;" ";: GET A$:GS =  VAL (A$): PRINT: IF GS<1 OR GS>GM THEN 910
 920  IF GN(GS) = 0 THEN PRINT GS;" IS DEAD.": GOTO 910
 930  RETURN
 ...
 1000  HOME: VTAB 21: PRINT "ATTACK # ";GS;" WITH ";: PRINT DW$(L)
 1005  IF GP%(L) = 0 AND WR = -1 THEN GOSUB 800
 1010 I =  RND (1) * 99 - AI%(L) - ZA%*2
 1020  IF I < WB/WU(L) THEN GOSUB 1100: GET A$: GOTO 1200
 ...
 2020  I = I + GA
 2022  IF WB < I THEN HOME: VTAB 21: PRINT "FAILED! ";: GOSUB 30050: RETURN
 2023  IF LEFT$(SD$,3) = "DEC" AND GO$ = "HYDRA" THEN HOME: VTAB 21: PRINT "HYDRA DECAPITATED BUT HEAD REGROWS! ";: GOSUB 30050: RETURN
 2024  HOME : VTAB 21: PRINT GO$;"# ";GS;" HAS BEEN": PRINT SD$: GOSUB 30010
 2026  IF SC$ = "T" THEN PM%(GS) = 4
 2028  IF SC$ = "P" THEN GN(GS) = 0: GOSUB 1861
 2030  GET A$: GOSUB 90: IF M = 0 THEN RETURN
 2032  MA = MA - 1: IF MA < 1 THEN RETURN
 2034  GOSUB 2100: IF GS = 0 THEN RETURN
 2036  GOTO 2024

 2040  IF SE$ = GD$ THEN  HOME : VTAB 21: PRINT GO$;" IMMUNE! ";: GOSUB 30050: RETURN
 2042  IF WB < I THEN HOME : VTAB 21: PRINT "FAILED! ";: GOSUB 30050: RETURN
 2044  HOME : VTAB 21: PRINT "SPELL SUCCESSFUL: ";: GOSUB 30030
 ...
 2056  GET A$: GOSUB 90: IF M = 0 THEN RETURN
 2058  MA = MA - 1: IF MA < 1 THEN RETURN
 2060  GOSUB 2100: IF GS = 0 THEN RETURN
 2062  GOTO 2044
 ...
 2800  PRINT "(W)EAPON/ITEM, (A)RMOR, (S)PELL- ";: GET A$
 2811  HOME : VTAB 21
 ...
 3310  PRINT GO$;"# ";L;" CASTING": PRINT GI$: GOSUB 30000
 ...
 3400  WZ% = 99: HOME: VTAB 21: PRINT GO$;"# ";L;" USING ";GC$: PRINT "AGAINST ";NM$(GS): GOSUB 30020
 ...
 3600  HOME: VTAB 21: PRINT "YOU ARE VICTORIOUS! ";: GET A$: IF DG% = 1 AND WT% = 13 THEN GOSUB 3700
 ...
 3720  TEXT: HOME: PRINT "YOU FOUND: ";W$: PRINT NM$(M);"'S ";: GOSUB 4210
 ...
 5202  IF DG% = 1 THEN BY = 32768 +  INT (XT / 2) + (YT * 10)
 5203  IF DG% = 0 THEN BY = 33618 +  INT (XT / 2) + (YT * 20)
