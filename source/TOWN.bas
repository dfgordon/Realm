 ...
 20  VTAB 20
 21  GET A$:AE = AE - .25: PRINT
 36  IF AE < 0 THEN 50000
 37  IF AE < 100 THEN 39
 38  GOTO 40
 ...
 210  PRINT "ATTACK DIRECTION: ";: GET A$
 ...
 510  GOSUB 5000: IF  PEEK (768) = 7 AND WY% = 0 THEN PRINT "BLOCKED BY MARINE. ";: GOSUB 30050: HOME : GOTO 100
 520  N = 15: GOSUB 5200: N = 4: GOSUB 5201: FL% = 16: HOME: GOTO 100
 ...
 7599  PRINT "NOBODY HERE! ";: GOSUB 30050: HOME : GOTO 100
 ...
 13030  NEXT
 13040  IF M > 0 THEN GOSUB 30040: GOSUB 40000: FS% = 0: GOTO 13050
 13049  GOTO 20

 13050  HOME: VTAB 21: IF FS% = 2 THEN FS% = 0: GOTO 20
 13051  FS% = FS% + 1: PRINT "FOOD": PRINT  INT (AE): PRINT "GOLD": PRINT AD%;
 13052  FOR I = 0 TO 3: VTAB 21 + I: HTAB 6
 13055  IF FS% = 1 THEN PRINT LEFT$(DW$(I),12);
 13056  IF FS% = 2 THEN PRINT LEFT$(DV$(I),12);
 13057  HTAB 19: PRINT LEFT$(DX$(I),12);: HTAB 32: PRINT AB%(I);"/";AC%(I);: NEXT
 13060  GOTO 20
