 ...
 190  HTAB 1: VTAB 10: GET A$: A =  VAL (A$)
 195  ON A GOTO 5000,1000,6000,2000,3000,4000,6400,7500
 199  GOTO 100
 ...
 1620  IF M = 1 THEN PRINT A$;" ALREADY USED";: GET A$: GOTO 1600
 1630  NA$ = A$
 ...
 6010  D = 3 : GOSUB 9000: GOSUB 900: HOME: PRINT "--DEPLOY/UPDATE--": PRINT: GOSUB 400 : IF M = 0 THEN 100
 6020  GOSUB 500
 6030  D = 0 : GOSUB 9000: GOSUB 900: IF PN$(0) <> "EMPTY" THEN 6200
 6100  PN$(0) = NA$ : GOSUB 950: GOSUB 700
 6110  HOME: PRINT "TO PLAY ";NA$: PRINT "BOOT FROM MASTER.";: GET A$: GOTO 100

 6200  REM RECALL PARTY
 6210  IF NA$ = PN$(0) THEN 6300
 6220  HOME: PRINT "MUST RECALL ";PN$(0);", OK? (Y/N) ";: GET A$: IF A$ <> "Y" AND A$ <> "N" THEN 6220
 6221  IF A$ = "N" THEN 100
 6230  SV$ = NA$: NA$ = PN$(0): GOSUB 500
 6240  PRINT: PRINT CHR$(4);"DELETE D:";NA$
 6250  D = 3: GOSUB 9000: GOSUB 700
 6260  NA$ = SV$: GOSUB 500
 6270  D = 0: GOSUB 9000: GOTO 6100

 6300  HOME: PRINT NA$;" ALREADY DEPLOYED.": PRINT "UPDATE STATUS ON SETUP DISK? (Y/N) ";: GET A$: IF A$ <> "Y" AND A$ <> "N" THEN 6300
 6310  IF A$ = "N" THEN 100
 6320  GOSUB 500: D = 3: GOSUB 9000: GOSUB 700: PRINT: PRINT "STATUS IS UPDATED. ";: GET A$: GOTO 100

 6400  REM IMPORT
 6401  ONERR GOTO 6499
 6410  HOME: PRINT "IMPORT: ANY DISK --> NEW SETUP DISK"
 6411  PRINT "NOTE: SHIPS ARE EXCLUDED."
 6412  PRINT "VERIFY NEW SETUP DISK IN D";WD%(3);"- ";: GET A$
 6420  PRINT: PRINT  CHR$(4);"VERIFY DISK3,S";WS%(3);",D";WD%(3)
 6430  GOSUB 900: GOSUB 1900: IF M=1 THEN HOME: PRINT "THERE IS NO ROOM ";:GET A$: GOTO 100
 6440  HOME: PRINT "NAME OF PARTY TO IMPORT- ":GOSUB 7000: NA$ = A$: GOSUB 1800: IF M = 0 THEN 6440
 6450  IF M = 1 THEN PRINT: PRINT NA$;" ALREADY HERE. ";: GET A$: GOTO 100
 6460  PRINT: PRINT "INSERT SOURCE DISK IN D";WD%(3);"- ";: GET A$
 6470  PRINT: PRINT  CHR$(4);"VERIFY D:";NA$;",S";WS%(3);",D";WD%(3)
 6480  POKE 216,0: GOSUB 500: PRINT "INSERT NEW SETUP DISK IN D";WD%(3);"- ";: GET A$: PRINT: GOTO 1700
 6499  HOME: PRINT "THERE WAS A DISK ERROR. ";: GET A$: POKE 216,0: GOTO 100
 ...
 7520  PRINT "A - ATTACK / SCUTTLE (OUTSIDE)": PRINT "B - BOARD SHIP": PRINT "C - CAST": PRINT "E - ENTER"
 7530  PRINT "F - FAST STATUS": PRINT "G - GET CHEST": PRINT "I - INVENTORY SWAP": PRINT "K - CLIMB LADDER"
 7540  PRINT "Q - SAVE/QUIT": PRINT "R - READY": PRINT "S - STEAL": PRINT "T - TRANSACT"
 ...
 7622  PRINT "AND WE WILL MAKE A LAST DESPARATE"
