 ...
 420  NA$ = A$: IF NA$ = "" OR NA$ = "EMPTY" THEN 450
 ...
 1020  GOSUB 900
 1030  I = 0
 1040  IF PN$(I) = "" OR PN$(I) = "EMPTY" THEN 1100
 ...
 1620  NA$ = A$
 1630  IF NA$ = "" OR NA$ = "EMPTY" THEN 1600
 1640  I = 0
 ...
 1740  I = 0
 1750  IF PN$(I) = "" OR PN$(I) = "EMPTY" THEN 1770
 ...
 5090  NEXT I
 5100  PRINT "ENTER DISK NAME, (F)INISH, OR (C)ANCEL": GOSUB 7000: PRINT
 5101  IF A$=DL$(0) OR A$=DL$(1) OR A$=DL$(2) OR A$=DL$(3) OR A$="F" OR A$="C" THEN 5110
 5102  INPUT "RESPONSE NOT VALID. PRESS ENTER.";A$
 5103  GOTO 5000
 5110  IF A$="F" THEN 5170
 5111  IF A$="C" THEN 100
