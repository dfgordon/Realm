...
9  POKE 33,35: POKE 35,24: HTAB M+1: VTAB N+1: RETURN

10  AA% = 0: GOSUB 100: HOME: GOSUB 150: POKE 33,35
...
325  IF W$ = "HAK" THEN C = 2: WA = 75:WB = 70: IF RND(1) > 0.67 THEN WB = 999: SC$ = "T": SD$ = "STUN"+"NED"
...
600  MA = 1: WA = 0: WB = 0: WR = 0: SC$ = "": SE$ = "N": W$ = LEFT$(DW$(A),2) + RIGHT$(DW$(A),1): GOSUB 300: IF WB = 0 THEN 2900
620  IF GP%(A) = 0 AND WR = 0 THEN 2920
...
2023  IF LEFT$(SD$,3) = "DEC" AND GO$ = "HYDRA" THEN PRINT "HYDRA IS DECAPITATED, BUT": PRINT "THE HEAD GROWS BACK! ";: GOSUB 30050: RETURN
...
2800  HOME: VTAB 21: PRINT NM$(A);" (ARROWS,A,Z,ENT,ESC)- ": FOR C=0 TO 2: DT%(C) = DR%(A,C): NEXT: C = 0
...
3206  IF PM%(A) > 0 THEN  PRINT GO$;"# ";A;" UNDER PARALYSIS! ";: GOSUB 30050: I = A: GOSUB 1: RETURN
...
3409  NEXT M
3410  IF I > RND (1) * 99  THEN PRINT "SAVED BY PROT.";WZ%;" ";: GOSUB 30050: RETURN
...
4600  TEXT: HOME: PRINT "YOU FOUND: ";B$: PRINT: GOSUB 4210: M = 0: N = 0: P = 7: I = 4: GOSUB 4450: IF M = 999 THEN RETURN
