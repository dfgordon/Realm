 ...
 4300  PRINT "FOR SALE:"
 4330  FOR I = 1 TO 8
 4340  ON I GOSUB 20000,20010,20020,20030,20040,20050,20060,20070
 4345  GOSUB 19000
 4350  PRINT I;") ";B$;" (";C;")"
 4360  NEXT I
 4370  RETURN
 ...
 9540  I = VAL(A$): IF I<1 OR I>8 THEN 9510
 9550  ON I GOSUB 20000,20010,20020,20030,20040,20050,20060,20070
 ...
 20020 C = 200: B$ = "POTION OF HEALING": RETURN
 20030 C = 200: B$ = "POTION OF PASSAGE": RETURN
 20040 C = 200: B$ = "POTION OF INFURIATION": RETURN
 20050 C = 500: B$ = "POTION OF INTIMIDATION": RETURN
 20060 C = 1000: B$ = "POTION OF VISION": RETURN
 20070 C = 4000: B$ = "FLYING CARPET": RETURN
