...
110  ES = 100: EP = 100: RB$ = "BIN" + "/": RD$ = "PROG" + "/"
120  GOSUB 5200
130  END
...
5210  PRINT : PRINT CHR$(4);"OPEN REALM/DD": PRINT CHR$(4);"CLOSE REALM/DD": PRINT CHR$(4);"DELETE REALM/DD"
5220  PRINT CHR$(4);"OPEN REALM/DD": PRINT CHR$(4);"WRITE REALM/DD"
5281  PRINT ES
5282  PRINT EP
5283  PRINT RB$
5284  PRINT RD$
