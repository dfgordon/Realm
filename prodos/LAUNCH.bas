 ...
 6400  REM IMPORT
 6401  HOME: ONERR GOTO 6600
 6402  PRINT "--IMPORT PARTY--"
 6410  PRINT CHR$(4);"PREFIX": INPUT P0$
 6420  GOSUB 6550: PD$ = P0$ + "PARTIES/": PS$ = P1$
 6430  HOME: PRINT "NAME OF PARTY:": GOSUB 7100: NA$ = A$
 6431  PRINT: PRINT "SOURCE PREFIX:": PRINT " ";PS$: PRINT "DESTINATION PREFIX:": PRINT " ";PD$
 6432  PRINT: PRINT "IF TWO DISKS BOTH MUST BE INSERTED."
 6440  PRINT "PRESS B TO BEGIN, OTHER KEY CANCELS- ";: GET A$: IF A$ <> "B"  THEN POKE 216,0: GOSUB 6720: GOTO 100
 ...
 6502  PRINT "--EXPORT PARTY--"
 6510  PRINT CHR$(4);"PREFIX": INPUT P0$
 6520  GOSUB 6550: PS$ = P0$ + "PARTIES/": PD$ = P1$: GOTO 6430
 ...
 6553  PRINT D: PRINT "INSERT DISK (ESC CANCELS)- ";:GET A$: IF A$ = CHR$(27) THEN POKE 216,0: GOTO 100
