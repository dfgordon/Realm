 ...
 195  ON A GOTO 5000,1000,6000,2000,3000,4000,6400,6500
 199  GOTO 100
 ...
 6020  B$ = "PARTIES/": GOSUB 500: FS% = 0: MD% = 0
 6030  PRINT CHR$(4);"BLOAD BIN/S2"
 6040  PRINT CHR$(4);"BLOAD PARTIES/";LEFT$(RM$,2);".";NA$
 6050  PRINT CHR$(4);"BLOAD PROG/OUTSIDE"
 6060  POKE 16384,0: POKE 103,1: POKE 104,64: POKE 175,255: POKE 176,108: GOTO 1

 6400  REM IMPORT
 6401  HOME: REM ONERR GOTO 6600
 6402  PRINT "--IMPORT PARTY--": PRINT: PRINT "THIS REQUIRES TWO DRIVES.": PRINT "VOLUME NAMES MUST BE DISTINCT.": PRINT "EXISTING FILES ARE OVERWRITTEN."
 6410  PRINT CHR$(4);"PREFIX": INPUT P0$: PD$ = P0$ + "PARTIES/"
 6420  PRINT "DESTINATION PREFIX IS ";PD$
 6430  PRINT: PRINT "SOURCE PREFIX:": INPUT PS$
 6431  PRINT: PRINT "NAME OF PARTY:": GOSUB 7100: NA$ = A$
 6440  HOME: PRINT "MAKE SURE ALL DISKS INSERTED."
 6441  PRINT: PRINT "PRESS B TO BEGIN, ESC CANCELS- ";: GET A$: IF A$ <> "B"  AND A$ <> CHR$(27) THEN 6440
 6442  IF A$ = CHR$(27) THEN POKE 216,0: GOTO 100
 ...
 6500  REM EXPORT
 6501  HOME: ONERR GOTO 6600
 6502  PRINT "--EXPORT PARTY--": PRINT: PRINT "THIS REQUIRES TWO DRIVES.": PRINT "VOLUME NAMES MUST BE DISTINCT.": PRINT "EXISTING FILES ARE OVERWRITTEN."
 6510  PRINT CHR$(4);"PREFIX": INPUT P0$: PS$ = P0$ + "PARTIES/"
 6520  PRINT "SOURCE PREFIX IS ";PS$
 6530  PRINT: PRINT "DESTINATION PREFIX:": INPUT PD$
 6531  GOTO 6431

 6600  HOME: PRINT "THERE WAS A DISK ERROR. ";: GET A$: GOSUB 6720: POKE 216,0: GOTO 100
 ...
 9200  HOME : PRINT "PLEASE INSERT DISK- ";: GET A$
 9210  CALL 768: PRINT : RESUME
