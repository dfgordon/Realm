 ...
 370  PG$ = "COM" + "BAT": DG% = 1
 371  PRINT CHR$(4);"BLOAD PROG/CHAIN"
 372  POKE 216,0: POKE 4096,0: POKE 103,1: POKE 104,16: GOTO 10
 ...
 860  GOSUB 5100: IF XT<0 OR XT>19 OR YT<0 OR YT>159 THEN GOSUB 880: GOTO 812
 870  GOSUB 5001
 ...
 1050  GOSUB 850: IF PEEK(768) <> 8 THEN 812
 ...
 5001  POKE 8189,110: POKE 8188,0: GOSUB 5050: POKE 4,0: POKE 5,0: CALL 7076: RETURN

 5010  POKE 8189,110: POKE 8188,0: POKE 8186,0
 ...
 9050  PRINT: ONERR GOTO 9250
 9051  PRINT CHR$(4);"BLOAD MONSTERS/FRAMED,A$6D00"
 9052  PRINT CHR$(4);"BLOAD BIN/MRC3"
 9053  PRINT CHR$(4);"BLOAD BIN/SDP.INTRP,A$1100"
 9054  POKE 216,0: POKE 4610,28: POKE 7680,173: POKE 7683,96
 ...
 10105  ONERR GOTO 9250
 10110  PRINT  CHR$(4);"BLOAD PROG/HIGH.PRIEST"
 10120  POKE 216,0: POKE 4096,0: POKE 103,1: POKE 104,16: GOTO 10
 ...
 14991  ONERR GOTO 9250
 14992  PRINT CHR$(4);"BLOAD MONSTERS/FRAMEM,A$6D00"
 14993  GOSUB 380: CALL 4352
 14994  PRINT CHR$(4);"BLOAD MONSTERS/MORDOCK,A$6D00"
 14995  GOSUB 380: CALL 4355: GOSUB 381
 14998  PRINT CHR$(4);"BLOAD PROG/MORDOCK"
 14999  POKE 216,0: POKE 2048,0: POKE 103,1: POKE 104,8: GOTO 5
