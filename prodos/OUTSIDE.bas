 1  HGR: ROT=0: SCALE=1: POKE 232,0: POKE 233,10: REM BRUSHES
 3  PRINT CHR$(4);"BLOAD BIN/OUTSPS"
 4  PRINT CHR$(4);"BLOAD BIN/OUTSIDE.INTRP"
 5  PRINT CHR$(4);"BLOAD BIN/MRC3"
 6  PRINT CHR$(4);"BLOAD BIN/SDP.INTRP,A$1100"
 10  GOSUB 300

 12  PRINT CHR$(4);"BLOAD MONSTERS/FRAMEO,A$6D00"
 13  REM CHANGE MAP ADDRESS TO $6E00
 14  POKE 6519,110: POKE 6558,110: POKE 6577,110: POKE 6608,110: POKE 7039,110: POKE 7117,110
 15  POKE 7680,173: POKE 7683,96: REM ALL PAINTERS NEED THIS LDA/RTS
 16  POKE 5089,0: REM MAYBE FOR MRC3
 17  GOSUB 380: CALL 4352: GOSUB 381
 18  HOME : GOTO 100

 20  GOSUB 13050: VTAB 20: GET A$: PRINT: AE = AE - .5 + .012*FL%: IF AE < 0 THEN 50000
 ...
 380  POKE 768,189: POKE 769,0: POKE 770,109: POKE 771,96: RETURN
 ...
 5010  POKE 8189,110: POKE 8188,0: POKE 8187,FL%: GOSUB 5050: CALL 6384: RETURN
 ...
 8110  PRINT CHR$(4);"BLOAD PROG/CHAIN"
 ...
 8351  ONERR GOTO 9250
 8352  HOME: VTAB 21: PRINT TAB(20-LEN(A$)/2);A$: FOR P = 0 TO EP: NEXT P: IF MD%=0 THEN 8360
 8353  PRINT CHR$(4);"BSAVE PARTIES/";LEFT$(RM$,2);".";NA$;",A$6E00,L3200": MD% = 0
 8360  RM$ = LEFT$(B$+" ",LEN(B$))
 8370  PRINT CHR$(4);"BLOAD PARTIES/";LEFT$(RM$,2);".";NA$;",A$6E00"
 8380  POKE 216,0: GOSUB 300: X = XT: Y = YT: HOME: GOTO 100
 ...
 10020  PRINT: ONERR GOTO 9250
 10030  PRINT CHR$(4);"BLOAD PROG/SAVE.GAME"
 10040  POKE 216,0: POKE 2048,0: POKE 103,1: POKE 104,8: GOTO 0
