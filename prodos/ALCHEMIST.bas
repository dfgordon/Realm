 ...
 4300  PRINT "FOR SALE:"
 4330  FOR I = 1 TO 7
 4340  ON I GOSUB 20000,20010,20020,20030,20040,20050,20060
 4345  GOSUB 19000
 4350  PRINT I;") ";B$;" (";C;")"
 4360  NEXT I
 4370  RETURN
 ...
 9540  I = VAL(A$): IF I<1 OR I>7 THEN 9510
 9550  ON I GOSUB 20000,20010,20020,20030,20040,20050,20060
 ...
 20060 C = 4000: B$ = "FLYING CARPET": RETURN
